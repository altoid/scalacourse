...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(filter_on_tokens(google))
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(filter_on_tokens(apple))
